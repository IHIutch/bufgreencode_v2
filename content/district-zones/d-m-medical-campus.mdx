...
<TableSmall>
  | | | | | ----- | ------------------------- | ---- | | **C** | Building
  coverage (max) | 90% | | **D** | Impervious coverage (max) | 100% |
</TableSmall>
...
<TableSmall>
  | | | | | ----- | ------------------------ | --- | | **A** | Front yard (min)
  | 0’ | | **B** | Corner side yard (min) | 0’ | | **C** | Interior side yard
  (min) | 0’ | | **D** | Rear yard (min) | 0’ |
</TableSmall>
...
<TableSmall>
  | | | | | ----- | --------------------- | -------------------------- | | **A**
  | Building height (max) | 6 stories <Sup>1</Sup> |
</TableSmall>

**Supplemental Standards**

<Sup>1</Sup> Up to 16 stories may be allowed only with approval of City Planning
...
<TableSmall>
  ...
  ------------------------------------------------------------- |
  ----------------------------------------------------------------------------------------------
  | | **A** | Ground floor transparency, front facade (min) | 30%; 60% if across
  a public right-of- way and within 150’ of an N-1D, N-1C, N-2C, or N-3C zone |
  | **B** | Ground floor transparency, corner side facade (min) | 30%; 60% if
  across a public right-of- way and within 150’ of an N-1D, N-1C, N-2C, or N-3C
  zone | | **C** | Upper floor transparency, front and corner side facades (min)
  | 20% |
</TableSmall>
