...
<TableSmall>
  | | | | | ----- | ------------------------- | --- | | **B** | Building
  coverage (max) | 80% | | **C** | Impervious coverage (max) | 90% |
</TableSmall>
...
<TableSmall>
  | | | | | ----- | --------------------- | ------------------------- | | **A**
  | Building height (max) | 3 stories<Sup>1</Sup> |
</TableSmall>

**Supplemental Standards**

<Sup>1</Sup> The maximum height may be increased to up to 1 times the height of the
...
<TableSmall>
  | | | | | ----- | ------------------------------------- | ----- | | **B** |
  Finished ground floor level (min/max) | 0’/4’ |
</TableSmall>
...
<TableSmall>
  ...
  ------------------------------------------------------------- |
  -------------------------------------------------------------------------------
  | | **A** | Ground floor transparency, front facade (min) | 20% for
  residential uses; 70% for retail & service uses; 40% for all other uses | |
  **B** | Ground floor transparency, corner side facade (min) | 20% for
  residential uses; 40% for all other uses | | **C** | Upper floor transparency,
  front and corner side facades (min) | 20% |
</TableSmall>
...
<TableSmall>
  | | | | | ----- | ---------------------------------- | ------------ | | **D**
  | Main entrance location (preferred) | Front facade |
</TableSmall>
