...
<TableSmall>
  | | | | | ----- | ------------------------- | ---- | | **C** | Building
  coverage (max) | 100% | | **D** | Impervious coverage (max) | 100% |
</TableSmall>
...
<TableSmall>
  ...
  level (min/max) | N/A | | Ground story height (min) | N/A |
</TableSmall>
...
<TableSmall>
  | | | | | ----- | ---------------------------------- |
  ---------------------------- | | **A** | Main entrance location (preferred) |
  Front or corner side facades |
</TableSmall>
